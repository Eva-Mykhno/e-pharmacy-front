...
//             <picture>
//               <source srcSet="/img/one-1x.webp 1x, /img/one-2x.webp 2x, /img/one-1x.jpg 1x, /img/one-2x.jpg 2x" />
//               <img
//                 src="/img/one-1x.jpg"
//                 alt="reviewrs photo"
//                 className={s.image}
...
//               <p className={s.name}>Leroy Jenkins</p>
//               <p className={s.date}>2 days ago</p>
//             </div>
//           </div>
...
//         <p className={s.text}>
//           I&rsquo;ve been using Moringa powder in my smoothies for a few weeks
//           now. My energy levels are up, and I feel great. I followed the
//           recommended dosage, and it seems to be a perfect addition to my daily
//           routine. Highly recommend!
//         </p>
//       </li>
//       <li className={s.item}>
//         <div className={s.wrapper}>
//           <div className={s.photo}>
//             <picture>
//               <source srcSet="/img/two-1x.webp 1x, /img/two-2x.webp 2x, /img/two-1x.jpg 1x, /img/two-2x.jpg 2x" />
//               <img
//                 src="/img/two-1x.jpg"
//                 alt="reviewrs photo"
//                 className={s.image}
...
//           <div className={s.photo}>
//             <picture>
//               <source srcSet="/img/three-1x.webp 1x, /img/three-2x.webp 2x, /img/three-1x.jpg 1x, /img/three-2x.jpg 2x" />
//               <img
//                 src="/img/three-1x.jpg"
//                 alt="reviewrs photo"
//                 className={s.image}
//               />
//             </picture>
